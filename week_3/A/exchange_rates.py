...
exchange_rate_per_currency = eu_exchange_rates.groupby('Currency')['Rate'].apply(lambda x: list(np.unique(x))) # https://stackoverflow.com/questions/36106490/how-to-get-unique-values-from-multiple-columns-in-a-pandas-groupby
